...
describe('NgffSelect', () => {
  let component: NgffSelect;
  let fixture: ComponentFixture<NgffSelect>;

  beforeEach(async () => {
    TestBed.overrideTemplate(NgffSelect, '<div></div>');
    await TestBed.configureTestingModule({
      imports: [NgffSelect],
    }).compileComponents();

    fixture = TestBed.createComponent(NgffSelect);
